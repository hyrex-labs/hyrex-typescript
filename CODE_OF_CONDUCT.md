# Hyrex TypeScript SDK – Code of Conduct

This Code of Conduct is adapted from the Next.js project and the
Contributor Covenant, version 2.1.

## Our Pledge

We as members, contributors, and leaders pledge to make participation in the
Hyrex TypeScript SDK community a harassment‑free experience for everyone,
...
- Preferred: email the maintainers at [REPLACE_WITH_PROJECT_CONTACT_EMAIL]
- If email is not available, contact a maintainer privately via GitHub
...
version 2.1, and the approach used by the Next.js project.
