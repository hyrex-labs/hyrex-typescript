...
# Copy required proto files into local proto dir
cp ${proto_source}/proto/task.proto ${LOCAL_PROTO_DIR}/
cp ${proto_source}/proto/gateway.proto ${LOCAL_PROTO_DIR}/
cp ${proto_source}/proto/requests.proto ${LOCAL_PROTO_DIR}/
