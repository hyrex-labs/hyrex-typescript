...
CREATE INDEX IF NOT EXISTS idx_hte_queued_started_finished 
    ON hyrex_task_execution(queued, started, finished);
    
CREATE INDEX IF NOT EXISTS idx_hyrex_task_execution_root_id 
    ON hyrex_task_execution(root_id);
`
