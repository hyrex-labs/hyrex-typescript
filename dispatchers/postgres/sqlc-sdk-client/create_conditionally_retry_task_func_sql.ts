...
export const createConditionallyRetryTaskFuncQuery = `-- name: CreateConditionallyRetryTaskFunc :exec
...
export async function createConditionallyRetryTaskFunc(client: Client): Promise<void> {
    await client.query({
        text: createConditionallyRetryTaskFuncQuery,
        values: [],
        rowMode: "array"
    });
}
