...
export const fillHistoricalTaskStatusCountsTableQuery = `-- name: FillHistoricalTaskStatusCountsTable :exec
...
export async function fillHistoricalTaskStatusCountsTable(client: Client): Promise<void> {
    await client.query({
        text: fillHistoricalTaskStatusCountsTableQuery,
        values: [],
        rowMode: "array"
    });
}
